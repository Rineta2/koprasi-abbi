...
interface TransactionErorProps {
    error: string;
}

export default function TransactionEror({ error }: TransactionErorProps) {
    return (
                ...
                <div className="max-w-4xl mx-auto p-6 sm:p-8 bg-slate-900/90 rounded-3xl shadow-2xl backdrop-blur-xl border border-sky-500/20">
                    <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                        ...
                        <div className="flex-1 text-center lg:text-left space-y-6">
                            ...
                            <p className="text-slate-300 text-lg sm:text-xl font-medium">{error}</p>
