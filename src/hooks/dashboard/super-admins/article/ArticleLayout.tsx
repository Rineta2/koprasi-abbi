...
import { Articles } from '@/hooks/dashboard/super-admins/article/lib/article'

import ArticleModal from '@/hooks/dashboard/super-admins/article/ui/ArticleModal'

import Image from 'next/image'

import ArticleSkeleton from '@/hooks/dashboard/super-admins/article/ArticleSkelaton'
...
export default function ArticleLayout() {
    ...
    const [viewArticle, setViewArticle] = useState<Articles | null>(null)
    ...
    const handleView = (article: Articles) => {
