        ...
        <dialog id="tags_modal" className="modal">
            <div className="fixed inset-0 bg-text/90 backdrop-blur-sm z-50 overflow-y-auto">
                <div className="flex items-center justify-center min-h-screen p-4">
                    <div className="bg-card rounded-3xl shadow-2xl w-[90%] max-w-2xl p-8">
                        <div className="flex items-center justify-between mb-6">
                            <div className="space-y-1">
                                ...
                                <p className="text-sm text-text-dark">
                                    {isEditing ? 'Update existing tags' : 'Add a new tags to your projects'}
                                </p>
                            </div>
                            <button
                                onClick={onClose}
                        ...
                        <form method="dialog" onSubmit={onSubmit} className="space-y-8">
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-text-dark">Tags Title</label>
                                <input
                                    type="text"
                                    value={formData.title}
                                    onChange={(e) => onChange(e.target.value)}
                                    className="w-full px-4 py-2.5 text-text-dark bg-transparent border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200"
