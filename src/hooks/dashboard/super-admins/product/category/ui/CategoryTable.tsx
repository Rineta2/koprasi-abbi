                    ...
                    <table className="w-full divide-y divide-border/20">
                        ...
                        <tbody className="divide-y divide-border/10 bg-card">
                            {currentCategory.map((category) => (
                                <tr key={category.id} className="hover:bg-card-hover transition-colors duration-200">
                                    ...
                                    <td className="px-4 py-3 whitespace-nowrap text-right text-sm flex justify-center">
                                        ...
                                        <button
                                            ...
                                            className="inline-flex items-center px-3 py-1.5 bg-red-50 text-red-600 hover:bg-red-100 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/30 rounded-lg transition-colors duration-200"
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
