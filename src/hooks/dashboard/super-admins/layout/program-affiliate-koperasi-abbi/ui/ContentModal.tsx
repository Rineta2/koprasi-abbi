...
import { ContentModalProps } from '@/hooks/dashboard/super-admins/layout/program-affiliate-koperasi-abbi/lib/ProgramAffliateKoperasiAbbi';
...
export const ContentModal: React.FC<ContentModalProps> = ({
    ...
    const addBenefit = () => {
        setFormData({
            ...formData,
            benefits: [...formData.benefits, { title: '', text: '', price: '', imageUrl: '' }]
        });
    };
    ...
    const updateBenefitText = (index: number, value: string) => {
        const newBenefits = [...formData.benefits];
        newBenefits[index] = {
            ...newBenefits[index],
            text: value
    ...
    const updateBenefitPrice = (index: number, value: string) => {
        const newBenefits = [...formData.benefits];
        newBenefits[index] = {
            ...newBenefits[index],
            price: value
                                                    ...
                                                    <div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <input
                                                                type="text"
                                                                value={benefit.price}
                                                                onChange={(e) => updateBenefitPrice(index, e.target.value)}
                                                                className="w-full px-4 py-3 bg-background border-2 border-background-dark rounded-xl"
                                                                placeholder="Enter benefit price..."
                                                                required
                                                            />
                                                        </div>
                                                    </div>
