...
import { AboutFormProps } from '@/hooks/dashboard/super-admins/layout/about/lib/schema';
                                        ...
                                        <div className="space-y-5">
                                            <div className="form-control">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full px-4 py-2.5 rounded-xl border-2 border-border/50 bg-card text-text focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-200"
                                            ...
                                            <div className="form-control">
                                                <label className="block text-sm font-medium text-text mb-1.5">Text</label>
                                                <textarea
                                                    value={formData.text}
                                                    onChange={(e) => setFormData({ ...formData, text: e.target.value })}
                                                    className="w-full px-4 py-2.5 rounded-xl border-2 border-border/50 bg-card text-text focus:ring-2 focus:ring-primary focus:border-primary min-h-[120px] transition-all duration-200 resize-none"
