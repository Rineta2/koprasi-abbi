        ...
        <dialog id="content_modal" className="modal">
            <div className="fixed inset-0 bg-text/60 backdrop-blur-sm z-50 overflow-y-auto">
                <div className="flex items-center justify-center min-h-screen p-4">
                    <div className="bg-background rounded-2xl border border-border shadow-xl max-w-2xl w-full p-6 md:p-8 max-h-[90vh] overflow-y-auto custom-scrollbar">
                        ...
                        <form method="dialog" onSubmit={(e) => {
                            ...
                            <div className="w-full max-w-2xl mx-auto">
                                ...
                                {(selectedImage || formData.imageUrl) ? (
                                    ...
                                    <div className="flex items-center justify-center w-full">
                                        <label className="w-full flex flex-col items-center px-4 py-6 bg-card rounded-xl border-2 border-border border-dashed cursor-pointer hover:bg-card/70 transition-colors duration-200">
                            ...
                            <div className="flex justify-end gap-3 pt-6 border-t border-border">
                                <button
                                    type="button"
                                    className="px-5 py-2.5 text-text hover:bg-card rounded-xl transition-all duration-200 hover:shadow-md font-medium"
                                ...
                                <button
                                    type="submit"
                                    className="px-5 py-2.5 bg-primary hover:bg-primary/90 text-white rounded-xl transition-all duration-200 disabled:opacity-50 font-medium flex items-center gap-2"
                                    disabled={isSubmitting}
                                >
                                    {isSubmitting ? (
                                        <>
