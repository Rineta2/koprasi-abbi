...
import PrizeForm from '@/hooks/dashboard/super-admins/layout/prize-pool/ui/PrizeForm'

import PrizePoolSkeleton from '@/hooks/dashboard/super-admins/layout/prize-pool/PrizePoolSkelaton'
...
export default function PrizePoolLayout() {
    ...
    if (prizes.length === 0) {
        return <div className='text-center text-gray-500'>No prizes available</div>
    }
        ...
        <section className='min-h-full px-0 sm:px-2'>
            ...
            >
                <div className="space-y-3">
                    ...
                    <p className='text-lg'>Manage your prize pool</p>
                </div>
                                ...
                                <button
                                    onClick={async () => {
                                        if (window.confirm('Are you sure you want to delete this prize?')) {
                                            try {
                                                await prizeService.deletePrize(prize.id, prize.imageUrl)
                                                fetchPrizes()
                                            } catch (err) {
