...
import InsplensiasiSkelaton from '@/hooks/dashboard/super-admins/layout/data-blockchain/DataBlockcheinSkelaton'

import { DataBlockchainContent } from '@/hooks/dashboard/super-admins/layout/data-blockchain/lib/DataBlockchain'

import { ContentModal } from '@/hooks/dashboard/super-admins/layout/data-blockchain/ui/ContentModal'

import { DeleteModal } from '@/hooks/dashboard/super-admins/layout/data-blockchain/ui/DeleteModal'

import { useDataBlockchainData } from '@/hooks/dashboard/super-admins/layout/data-blockchain/lib/FetchDataBlockchain'

const initialFormData: DataBlockchainContent = {
    title: '',
    imageUrl: ''
};
...
export default function DataBlockcheinLayout() {
    const {
        ...
        handleUpdate,
        handleDelete,
    } = useDataBlockchainData();

    const [selectedImage, setSelectedImage] = useState<File | null>(null)
    const [formData, setFormData] = useState<DataBlockchainContent>(initialFormData)
                ...
                {blockchain.length > 0 ? (
                    ...
                    >
                        <div className="flex flex-col">
                            ...
                            >
                                <Image
                                    src={blockchain[0].imageUrl}
                                    alt={blockchain[0].title}
                                    width={500}
                                    height={500}
                            ...
                            >
                                <div className="space-y-8 max-w-2xl mx-auto">
                                    ...
                                    <div className="flex justify-center gap-4 pt-8 border-t border-border/30">
                                        ...
                                        <button
                                            onClick={() => {
                                                setFormData(blockchain[0])
                                                setIsEditing(true)
                                                setEditingId(blockchain[0].id || null)
                                                const modal = document.getElementById('content_modal') as HTMLDialogElement | null
                                                modal?.showModal()
                                            }}
