...
import PendaftaranAnggotaSkelaton from '@/hooks/dashboard/super-admins/layout/pendaftaran-anggota/PendaftaranAnggotaSkelaton'

import { PendaftaranAnggotaContent } from '@/hooks/dashboard/super-admins/layout/pendaftaran-anggota/lib/pendaftarananggota'

import { ContentModal } from '@/hooks/dashboard/super-admins/layout/pendaftaran-anggota/ui/ContentModal'

import { DeleteModal } from '@/hooks/dashboard/super-admins/layout/pendaftaran-anggota/ui/DeleteModal'

import { usePendaftaranAnggotaData } from '@/hooks/dashboard/super-admins/layout/pendaftaran-anggota/lib/FetchPendaftaranAnggota'

const initialFormData: PendaftaranAnggotaContent = {
    title: '',
    description: '',
    svgUrl: '',
    imageUrl: ''
...
export default function HomeLayout() {
    const {
        ...
        handleUpdate,
        handleDelete,
    } = usePendaftaranAnggotaData();

    const [selectedImage, setSelectedImage] = useState<File | null>(null)
    const [selectedSvg, setSelectedSvg] = useState<File | null>(null)
    const [formData, setFormData] = useState<PendaftaranAnggotaContent>(initialFormData)
    ...
    if (isLoading) {
        return <PendaftaranAnggotaSkelaton />
    }
                    ...
                    >
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                            ...
                            <motion.div
                                ...
                                className="grid grid-cols-1 lg:grid-cols-2 gap-0 place-items-center"
                            >
                                {/* SVG Display - Add this section */}
                                {contents[0].svgUrl && (
