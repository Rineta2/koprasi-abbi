...
import TrendBisnisSkelaton from '@/hooks/dashboard/super-admins/layout/trend-bisnis/TrendBisnisSkelaton'

import { TrendBisnisContent } from '@/hooks/dashboard/super-admins/layout/trend-bisnis/lib/trendbisnis'

import { ContentModal } from '@/hooks/dashboard/super-admins/layout/trend-bisnis/ui/ContentModal'

import { DeleteModal } from '@/hooks/dashboard/super-admins/layout/trend-bisnis/ui/DeleteModal'

import { useTrendBisnisData } from '@/hooks/dashboard/super-admins/layout/trend-bisnis/lib/FetchTrendBisnis'

const initialFormData: TrendBisnisContent = {
    title: '',
    description: '',
    svgUrl: '',
    imageUrl: ''
...
export default function HomeLayout() {
    ...
    const [formData, setFormData] = useState<TrendBisnisContent>(initialFormData)
