...
import AdminSkeleton from '@/hooks/dashboard/super-admins/accounts/admins/AdminSkeleton';
...
export default function AdminContent() {
    ...
    if (!user || user.role !== Role.SUPER_ADMIN) {
        return <div className='text-text-dark'>Anda tidak memiliki akses ke halaman ini</div>;
    }
        ...
        <section className="min-h-full py-0 px-0 sm:py-4 sm:px-4">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div className='flex flex-col gap-1.5'>
                    <h1 className="text-2xl md:text-3xl font-bold text-text-dark tracking-tight">Admin & Super Admins List</h1>
                    <p className="text-sm md:text-base text-text-dark">Manage and track your accounts</p>
                </div>

                <button
                    className="w-full md:w-auto px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl shadow-sm transition-all duration-200 flex items-center justify-center md:justify-start gap-2 active:scale-95"
