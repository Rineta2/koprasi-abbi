...
export default function UserLayout() {
    ...
    const [accountTypeFilter, setAccountTypeFilter] = useState<'all' | 'regular' | 'premium'>('all')
    ...
    const filteredUsers = users.filter(user => {
        ...
        const matchesAccountType =
            accountTypeFilter === 'all' ? true :
                accountTypeFilter === user.accountType
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-6">
                <div className="flex-1">
                    <input
                        ...
                        className="w-full px-4 py-2.5 rounded-xl border bg-transparent border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                    />
                </div>
                ...
                <div className="w-full md:w-48">
                    <select
                        ...
                        onChange={(e) => setAccountTypeFilter(e.target.value as 'all' | 'regular' | 'premium')}
                        className="w-full px-4 py-2.5 rounded-xl border bg-transparent border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                    >
                    ...
                    <table className="min-w-full divide-y divide-gray-200/80">
                        <thead className="bg-gray-50/50 backdrop-blur-sm">
                            <tr>
                                ...
                                <th className="px-4 sm:px-6 py-5 text-left text-xs sm:text-sm font-semibold text-gray-600 tracking-wider">Account Type</th>
                        ...
                        >
                            {paginatedUsers.map((user, index) => (
                                ...
                                >
                                        ...
                                        <div className="flex items-center gap-3 sm:gap-4">
                                            {user.photoURL ? (
                                                ...
                                                <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-2xl bg-gradient-to-br from-gray-100 to-gray-50 flex items-center justify-center shadow-sm border border-gray-100/80">
                                                    <span className="text-gray-600 text-base sm:text-lg font-medium">{user.fullName?.[0]}</span>
                                                </div>
                                            )}
                                            <div>
                                                <div className="text-sm sm:text-base font-medium text-gray-900">{user.fullName}</div>
                                    ...
                                    <td className="px-4 sm:px-6 py-5 whitespace-nowrap">
                                        <span className={`px-3 py-1.5 inline-flex text-xs leading-5 font-medium rounded-full transition-colors duration-200 
                                            ${user.accountType === 'premium'
                                                ? 'bg-purple-50 text-purple-700 ring-1 ring-purple-600/20'
                                                : 'bg-gray-50 text-gray-700 ring-1 ring-gray-600/20'
                                            }`}>
                                            {user.accountType === 'premium' ? 'Premium' : 'Regular'}
                                        </span>
                                    </td>
                                ...
                                >
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-3 py-2 border border-gray-300 bg-transparent rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500"
                                            required
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-transparent focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500"
                                            required
                                        />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-gray-500">
                                            Masukan Nomber Telepon dengan Kode Negara (e.g., +1 untuk US, +44 untuk UK, +62 untuk Indonesia)
                                        </p>
                                    </div>
