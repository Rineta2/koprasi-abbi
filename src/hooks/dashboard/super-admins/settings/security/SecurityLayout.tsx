...
import DeleteAccountModal from '@/hooks/dashboard/super-admins/settings/security/ui/DeleteAccountModal'
    ...
    return (
        <section className="min-h-full px-0 sm:px-2">
            ...
            <motion.div
                ...
                className="bg-background backdrop-blur-2xl rounded-3xl shadow-2xl border border-border p-10 custom-scrollbar"
            >
                {/* Privacy Cards */}
                <div className="grid gap-6">
                    ...
                    <motion.div
                        ...
                        className="p-6 border border-border rounded-xl bg-card backdrop-blur-2xl shadow-lg transition-all"
                    >
