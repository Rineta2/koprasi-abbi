...
import { useStats } from '@/hooks/dashboard/super-admins/card/utils/useStats';

import { useChartData } from '@/hooks/dashboard/super-admins/card/utils/useChartData';

import Image from 'next/image';

import { useRecapAnalytics } from '@/hooks/dashboard/super-admins/card/utils/useRecapAnalytics';
                ...
                <div className="flex flex-wrap gap-4 md:gap-8">
                    ...
                    <div className="flex-1 min-w-[250px] bg-white backdrop-blur-lg rounded-3xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100/20">
                        <div className="flex items-center justify-between">
                            <div className="w-14 h-14 bg-pink-100/50 backdrop-blur rounded-2xl flex items-center justify-center">
                                <FiHandshake className="w-7 h-7 text-pink-600" />
                    ...
                    <div className="flex-1 min-w-[250px] bg-white backdrop-blur-lg rounded-3xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100/20">
                        <div className="flex items-center justify-between">
                            <div className="w-14 h-14 bg-orange-100/50 backdrop-blur rounded-2xl flex items-center justify-center">
                                <FiHandshake className="w-7 h-7 text-orange-600" />
                            </div>
                            <span className="px-4 py-1.5 bg-emerald-100/50 backdrop-blur text-emerald-600 text-sm font-medium rounded-full">Partners</span>
                        </div>
                        <h3 className="text-3xl font-bold mt-6 mb-2">{stats.totalPartners}</h3>
                        <p className="text-slate-600 text-sm font-medium">Total Partners</p>
                    </div>
                    ...
                    <div className="flex-1 min-w-[250px] bg-white backdrop-blur-lg rounded-3xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100/20">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="px-4 py-1.5 bg-emerald-100/50 backdrop-blur text-emerald-600 text-sm font-medium rounded-full">Network</span>
                        </div>
                        <h3 className="text-3xl font-bold mt-6 mb-2">{stats.totalReferralNetwork}</h3>
                        <p className="text-slate-600 text-sm font-medium">Total Referral Network</p>
                    </div>
                </div>
